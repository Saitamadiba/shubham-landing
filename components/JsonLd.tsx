export function OrganizationJsonLd() {
  const jsonLd = {
    ...
    '@type': 'Organization',
    name: 'Shubham Method',
    url: 'https://vedastro-ten.vercel.app',
    logo: 'https://vedastro-ten.vercel.app/logo.png',
...
export function PersonJsonLd() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Person',
    '@id': 'https://vedastro-ten.vercel.app/#author',
    name: 'Shubham Alock',
...
export function LocalBusinessJsonLd() {
  const jsonLd = {
    ...
    '@id': 'https://vedastro-ten.vercel.app/#localbusiness',
    ...
    email: 'Vedastro@pm.me',
    priceRange: '$$',
    image: 'https://vedastro-ten.vercel.app/og-image.png',
    address: {
      '@type': 'PostalAddress',
