...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      cryptoOptions: 'BTC, ETH, USDT, USDC',
    },
    // Crypto Checkout
    cryptoCheckout: {
      title: 'Pay with Cryptocurrency',
      subtitle: 'Send the exact amount to one of the addresses below',
      amount: 'Amount Due',
      selectCurrency: 'Select Currency',
      scanQr: 'Scan QR Code',
      orCopyAddress: 'Or copy address',
      copied: 'Copied!',
      afterPayment: 'After Payment',
      afterPaymentInstructions: 'Once you have sent the payment, please email us at',
      emailSubject: 'Subject',
      emailSubjectText: 'Crypto Payment - {plan}',
      includeInEmail: 'Include in your email',
      transactionId: 'Transaction ID / Hash',
      yourBirthDetails: 'Your birth details (date, time, place)',
      deliveryNote: 'Your report will be delivered within 24-48 hours after payment confirmation.',
      btcNote: 'Bitcoin Network Only',
    ...
    calculator: {
      ...
      subtitle: 'Discover the difference between your Western (Tropical) and Vedic (Sidereal) rising signs',
      form: {
        birthDate: 'Birth Date',
        birthTime: 'Birth Time',
      ...
      results: {
        ...
        lord: 'Nakshatra Lord',
        deity: 'Deity',
        difference: 'The ~24° difference between tropical and sidereal is due to the precession of equinoxes. Vedic astrology uses the sidereal zodiac aligned with the actual constellations.',
      },
      signs: {
        Aries: 'Aries',
        Taurus: 'Taurus',
      ...
      cta: {
        title: 'Want to know more about your Nakshatra?',
        subtitle: 'Get a complete 14-phase Vedic analysis with the Shubham Method',
        button: 'Get Your Full Report',
      },
      errors: {
        selectLocation: 'Please select a location from the suggestions',
        enterTime: 'Please enter your birth time',
        enterDate: 'Please enter your birth date',
      },
    },
  },
  fr: {
    ...
    checkout: {
      ...
      cardSecure: 'Paiement sécurisé via Stripe',
      cryptoOptions: 'BTC, ETH, USDT, USDC',
    },
    // Crypto Checkout
    cryptoCheckout: {
      title: 'Payer en Cryptomonnaie',
      subtitle: 'Envoyez le montant exact à l\'une des adresses ci-dessous',
      amount: 'Montant à Payer',
      selectCurrency: 'Choisir la Devise',
      scanQr: 'Scanner le QR Code',
      orCopyAddress: 'Ou copier l\'adresse',
      copied: 'Copié !',
      afterPayment: 'Après le Paiement',
      afterPaymentInstructions: 'Une fois le paiement envoyé, envoyez-nous un email à',
      emailSubject: 'Objet',
      emailSubjectText: 'Paiement Crypto - {plan}',
      includeInEmail: 'Inclure dans votre email',
      transactionId: 'ID de Transaction / Hash',
      yourBirthDetails: 'Vos détails de naissance (date, heure, lieu)',
      deliveryNote: 'Votre rapport sera livré sous 24-48 heures après confirmation du paiement.',
      btcNote: 'Réseau Bitcoin Uniquement',
    ...
    calculator: {
      ...
      form: {
        ...
        birthPlacePlaceholder: 'Rechercher une ville...',
        timezone: 'Fuseau horaire (décalage UTC)',
        calculate: 'Calculer l\'Ascendant',
        calculating: 'Calcul en cours...',
        noResults: 'Aucun lieu trouvé',
        searching: 'Recherche...',
      },
      results: {
        title: 'Vos Signes Ascendants',
        tropical: 'Tropical (Occidental)',
        sidereal: 'Sidéral (Védique)',
        ayanamsa: 'Ayanamsa Lahiri',
        nakshatra: 'Nakshatra',
        pada: 'Pada',
        lord: 'Seigneur du Nakshatra',
        deity: 'Divinité',
        difference: 'La différence d\'environ 24° entre le tropical et le sidéral est due à la précession des équinoxes. L\'astrologie védique utilise le zodiaque sidéral aligné avec les vraies constellations.',
      },
      signs: {
        Aries: 'Bélier',
        Taurus: 'Taureau',
      ...
      cta: {
        title: 'Voulez-vous en savoir plus sur votre Nakshatra ?',
        subtitle: 'Obtenez une analyse védique complète en 14 phases avec la Méthode Shubham',
        button: 'Obtenir Votre Rapport Complet',
      },
      errors: {
        selectLocation: 'Veuillez sélectionner un lieu parmi les suggestions',
        enterTime: 'Veuillez entrer votre heure de naissance',
        enterDate: 'Veuillez entrer votre date de naissance',
      },
    },
  },
}
